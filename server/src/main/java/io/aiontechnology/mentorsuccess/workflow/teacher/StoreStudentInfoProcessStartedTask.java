...
public class StoreStudentInfoProcessStartedTask implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        currentStudentSchoolSession.setStartedInfoFlowId(execution.getProcessInstanceId());
    }
