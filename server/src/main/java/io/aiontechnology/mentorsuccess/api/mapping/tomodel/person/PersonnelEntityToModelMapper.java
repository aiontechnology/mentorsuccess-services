...
/**
 * Mapper that converts a {@link SchoolPersonRole} to a {@link InboundPersonnel}.
 *
...
public class PersonnelEntityToModelMapper implements OneWayMapper<SchoolPersonRole, OutboundPersonnel> {

    /** Service for formatting phone numbers */
    private final PhoneService phoneService;

    /**
     * Map the given {@link SchoolPersonRole} to a {@link InboundPersonnel}.
     *
     * @param role The {@link SchoolPersonRole} to map.
     * @return The mapped {@link InboundPersonnel}.
     */
    @Override
    public Optional<OutboundPersonnel> map(SchoolPersonRole role) {
        return Optional.ofNullable(role)
                .map(r -> OutboundPersonnel.builder()
