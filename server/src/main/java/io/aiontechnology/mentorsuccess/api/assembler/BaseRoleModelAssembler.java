...
public abstract class BaseRoleModelAssembler<T extends RepresentationModel<T>>
     ...
     *
     * @param controllerClass The class of the related controller.
     * @param resourceType The class of the resource being assembled
     * @param mapper The mapper that will be used to map the related entity to a model object.
     * @param linkHelper A {@link LinkHelper} for adding links to the resource.
     */
