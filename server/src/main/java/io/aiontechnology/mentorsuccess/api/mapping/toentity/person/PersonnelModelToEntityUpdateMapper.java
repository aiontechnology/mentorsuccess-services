...
/**
 * Mapper that updates a {@link SchoolPersonRole} from a {@link InboundPersonnel}.
 *
...
public class PersonnelModelToEntityUpdateMapper implements OneWayUpdateMapper<InboundPersonnel, SchoolPersonRole> {

    /** Phone number formatting service */
    private final PhoneService phoneService;

    /**
     * Map the given {@link InboundPersonnel} ot the given {@link SchoolPersonRole}.
     *
     * @param inboundPersonnel The {@link InboundPersonnel} to map.
     * @param role The {@link SchoolPersonRole} to map to.
     * @return The resulting {@link SchoolPersonRole}.
     */
    @Override
    public Optional<SchoolPersonRole> map(InboundPersonnel inboundPersonnel, SchoolPersonRole role) {
        Objects.requireNonNull(role);
        return Optional.ofNullable(inboundPersonnel)
                .map(p -> {
