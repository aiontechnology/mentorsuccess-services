...
drop table if exists act_dmn_databasechangeloglock cascade;
drop table if exists act_dmn_databasechangelog cascade;
drop table if exists act_dmn_deployment cascade;
drop table if exists act_dmn_deployment_resource cascade;
drop table if exists act_fo_databasechangeloglock cascade;
drop table if exists act_dmn_hi_decision_execution cascade;
drop table if exists act_dmn_decision cascade;
drop table if exists act_fo_databasechangelog cascade;
drop table if exists act_fo_form_deployment cascade;
drop table if exists act_fo_form_resource cascade;
drop table if exists act_fo_form_definition cascade;
drop table if exists act_cmmn_databasechangelog cascade;
drop table if exists act_fo_form_instance cascade;
drop table if exists act_co_databasechangeloglock cascade;
drop table if exists act_co_databasechangelog cascade;
drop table if exists act_co_content_item cascade;
drop table if exists act_cmmn_databasechangeloglock cascade;
...
drop table if exists act_app_databasechangeloglock cascade;
drop table if exists act_app_databasechangelog cascade;
