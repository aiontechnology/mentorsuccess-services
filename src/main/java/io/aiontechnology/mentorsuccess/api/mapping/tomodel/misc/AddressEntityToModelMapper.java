...
/**
 * Mapper that converts a {@link AddressModel} to a {@link School}.
 *
...
public class AddressEntityToModelMapper implements OneWayMapper<School, AddressModel> {

    @Override
    public Optional<AddressModel> map(School school) {
        return Optional.ofNullable(school)
                .map(s -> AddressModel.builder()
