...
/**
 * Mapper that converts a {@link ActivityFocusModel} to a {@link ActivityFocus}.
 *
...
public class ActivityFocusModelToEntityMapper implements OneWayMapper<ActivityFocusModel, ActivityFocus> {

    /** Function that retrieves a {@link ActivityFocus} by its name */
    private final Function<String, Optional<ActivityFocus>> getter;

    /**
     * Map the given {@link ActivityFocusModel}
     *
     * @param activityFocusModel The {@link ActivityFocusModel} to map.
     * @return The resulting {@link ActivityFocus}.
     */
    @Override
    public Optional<ActivityFocus> map(ActivityFocusModel activityFocusModel) {
