...
/**
 * Mapper that converts a {@link SchoolPersonRole} to a {@link ProgramAdminModel}.
 *
...
public class ProgramAdminEntityToModelMapper implements OneWayMapper<SchoolPersonRole, ProgramAdminModel> {

    /** Service for formatting phone numbers */
    private final PhoneService phoneService;

    /**
     * Map the given {@link SchoolPersonRole} to a {@link ProgramAdminModel}.
     *
     * @param role The {@link SchoolPersonRole} to map.
     * @return The mapped {@link ProgramAdminModel}.
     */
    @Override
    public Optional<ProgramAdminModel> map(SchoolPersonRole role) {
        return Optional.ofNullable(role)
                .map(p -> ProgramAdminModel.builder()
