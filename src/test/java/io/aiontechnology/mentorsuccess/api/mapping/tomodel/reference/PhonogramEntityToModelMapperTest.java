...
/**
 * Tests for {@link PhonogramEntityToModelMapper}.
 *
 * @author Whitney Hunter
 * @since 0.3.0
 */
public class PhonogramEntityToModelMapperTest {
    ...
    void testMapping() throws Exception {
        ...
        phonogram.setId(id);
        phonogram.setName(name);

        PhonogramEntityToModelMapper phonogramEntityToModelMapper = new PhonogramEntityToModelMapper();

        // execute the SUT
        Optional<PhonogramModel> result = phonogramEntityToModelMapper.map(phonogram);
    ...
    void testNull() throws Exception {
        ...
        // execute the SUT
        Optional<PhonogramModel> result = phonogramEntityToModelMapper.map(null);
