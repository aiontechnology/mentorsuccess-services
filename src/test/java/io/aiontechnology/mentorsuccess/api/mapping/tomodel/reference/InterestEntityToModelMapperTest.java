 ...
 * @since 0.3.0
 */
public class InterestEntityToModelMapperTest {
    ...
    void testMapping() throws Exception {
        ...
        // execute the SUT
        Optional<InterestModel> result = interestEntityToModelMapper.map(interest);
    ...
    void testNull() throws Exception {
        ...
        // execute the SUT
        Optional<InterestModel> result = interestEntityToModelMapper.map(null);
