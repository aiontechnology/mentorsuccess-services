...
public class LeadershipSkillModelToEntityMapperTest {
    ...
    void testMapping() {
        ...
        // execute the SUT
        Optional<LeadershipSkill> result = leadershipSkillModelToEntityMapper.map(leadershipSkillModel);
    ...
    void testNotFound() {
        ...
        LeadershipSkillModel behaviorModel = LeadershipSkillModel.builder()
                .withName(leadershipSkillName)
                .build();
