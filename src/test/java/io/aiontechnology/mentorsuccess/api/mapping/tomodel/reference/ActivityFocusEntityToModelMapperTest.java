...
public class ActivityFocusEntityToModelMapperTest {
    ...
    void testMapping() throws Exception {
        ...
        // execute the SUT
        Optional<ActivityFocusModel> result = activityFocusEntityToModelMapper.map(activityFocus);
    ...
    void testNull() throws Exception {
        ...
        // execute the SUT
        Optional<ActivityFocusModel> result = activityFocusEntityToModelMapper.map(null);
