...
public class LeadershipSkillEntityToModelMapperTest {
    ...
    void testMapping() throws Exception {
        ...
        // execute the SUT
        Optional<LeadershipSkillModel> result = leadershipSkillEntityToModelMapper.map(leadershipSkill);
    ...
    void testNull() throws Exception {
        ...
        // execute the SUT
        Optional<LeadershipSkillModel> result = leadershipSkillEntityToModelMapper.map(null);
